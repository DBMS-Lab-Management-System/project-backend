...
$username = $password = $confirm_password =$reg_no= "";
$username_err = $password_err = $confirm_password_err = $reg_no_err="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($reg_no_err)){
        
        // Prepare an insert statement
        $sql = "INSERT INTO users (username, password,reg_no) VALUES (?, ?,?)";
         
        if($stmt = $link->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("sss", $param_username, $param_password,$param_reg_no);
